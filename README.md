...
6. 在“设置 > 外部系统 > 禅道”配置禅道后，可在待办或未决事项上点击“任务交接到禅道”。
7. 确认内容后导出 Markdown 或 HTML。
...
安装脚本会构建正式版 `v0.1.5`、创建 DMG、挂载并校验签名，然后安装到 `/Applications`。也可以直接下载 [v0.1.5 Release](https://github.com/leoyoul/AgendAI/releases/tag/v0.1.5) 中的 `AgendAI-v0.1.5-macOS-universal.dmg`，将左侧的“会小纪”拖到右侧的“Applications”。首次打开后，请在应用内完成模型配置。
