...
安装脚本会构建正式版 `v0.1.4`、创建 DMG、挂载并校验签名，然后安装到 `/Applications`。也可以直接下载 Release 中的 `AgendAI-v0.1.4-macOS-universal.dmg`，将左侧的“会小纪”拖到右侧的“Applications”。首次打开后，请在应用内完成模型配置。
