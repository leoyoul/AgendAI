...
plutil -replace CFBundleShortVersionString -string "${AGEND_AI_TEST_APP_VERSION:-0.1.4}" "$CONTENTS_DIR/Info.plist"
plutil -replace CFBundleVersion -string "${AGEND_AI_TEST_APP_BUILD:-5}" "$CONTENTS_DIR/Info.plist"
